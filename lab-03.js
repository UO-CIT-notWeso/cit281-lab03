...
const { greetings } = require("./lab-03-modules");
console.log(greetings("greetings to"));
...
const function_getCarMakeModelImplicit = (car) => car.make + " " + car.model

console.log(1, function_getCarMakeModelImplicit(car));
...
const function_getCarMakeModelExplicit = (car) => {
    return car.make + " " + car.model;
};
console.log(2, function_getCarMakeModelExplicit(car));
...
const function_getCarMakeModelDestructure = (car) => {
    const { make, model } = car;
    return car.make + " " + car.model;
}
console.log(3, function_getCarMakeModelDestructure(car));
...
const { reverseString, concatenateString } = require("./lab-03-modules");
